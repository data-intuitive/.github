...
**Data Intuitive** is a team of passionate data scientists and software engineers who help life scientists make sense of their data. We specialise in developing robust and scalable data workflows, benchmarking computational methods, and providing training to empower researchers.
...
**Our services:**
  ...
  * **Training:** We offer workshops and training sessions to help researchers acquire the skills and knowledge needed to effectively analyse their data.

**Featured products:**

  * **Viash:** A framework for developing and benchmarking bioinformatics workflows. ([viash.io](https://viash.io))
  * **Viash Hub:** A platform for sharing and discovering Viash workflows. (Available 2025)
  ...
  * **OpenPipelines:** A set of standardised pipelines for single-cell RNA-seq data analysis. ([openpipelines.bio](https://openpipelines.bio))
